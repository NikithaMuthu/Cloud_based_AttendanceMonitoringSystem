...
<div class="container">	
	...
	<div class="content">
		<div class="container-fluid">
			<div>   
				<a href="#"><strong><span class="ti-crown"></span> Faculty Section</strong></a>
				<hr>		
				<div class="panel-heading">
					<div class="row">
						...
						<div class="col-md-2" align="right">
							<button type="button" name="add" id="addTeacher" class="btn btn-success btn-xs">Add New Faculty</button>
						</div>
					</div>
				</div>
