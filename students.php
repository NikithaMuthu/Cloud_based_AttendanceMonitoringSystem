...
?>
<title>Cloud based Attendance Monitoring System</title>
		...
		<form method="post" id="studentForm" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label for="calendar" class="control-label">Admission Date</label>							
						<input type="date" class="form-control"  id="admission_date" name="admission_date" placeholder="mm/dd/yyyy">							
					</div>		
					<div class="form-group">
					...
					<div class="form-group">
						<label for="calendar" class="control-label">Date of Birth</label>							
